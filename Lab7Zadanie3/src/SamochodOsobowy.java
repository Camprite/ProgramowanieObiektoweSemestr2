...
public class SamochodOsobowy extends Samochod{
    ...
    public SamochodOsobowy(String marka ,String model ,String nadwozie ,String kolor ,int rok_produkcji ,int przebieg,int waga, int poj_silnika, int il_osob){
